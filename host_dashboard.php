            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        ?>  
                        <li>
                            <a href="stop_event.php"><i class="fa fa-social fa-fw"></i> Stop the Event</a>
                        </li>
                        <?php
                            }else{
                        ?>
...
<div class = "col-md-12">
                ...
                <div class="alert alert-success">
                            An event is going on currently.
                </div>
<?php
            }else{
?>
<div class="alert alert-danger">
            ...
            <div class = "row">
                <div class = "col-md-12">
                    ...
                    <ol>
                        <li>
                            You can start a new Reverse Coding event here. See the left menu.
                        </li>
                        <li>
                            Well, That's pretty much all you can do here, for now. lol
                        </li>
                    <ol>
                </div>
            </div>
